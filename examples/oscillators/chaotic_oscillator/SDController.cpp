...
//outputs
  o1_=1.0; //Using 1.0 is faster for convergence than 0.0
  o2_=1.0; //Using 1.0 is faster for convergence than 0.0
...
//	std::cerr << period_ << std::endl;
	...
	cL_ =0;
  n_=0;
  data_[0].o1 = o1_ = 1.0; //Using 1.0 is faster for convergence than 0.0
  data_[0].o2 = o2_ = 1.0; //Using 1.0 is faster for convergence than 0.0
