...
//This example illustrates the use of the the SLAMSolver class for the SLAM problem. For a more detailed and general introduction
...
//To visualize results, run 'python plotSLAM.py path stepNumber', which will show the computed and true path up to the step stepNumber,
//as well as the current map.
...
int main(int argc, char *argv[])
{
	...
	double variancePos = 0.01;
	double varianceVelo = 0.01;
	...
	//Generate map
	vector<double> start = boost::assign::list_of(-7.)(-22.); //Bottom left corner
	vector<double> end = boost::assign::list_of(27.)(22.); //Top right corner
	vector<double> resolution = boost::assign::list_of(1.)(1.); //Dimensions of one cell
	...
	double variance = 0.0; //Variance of initial states
