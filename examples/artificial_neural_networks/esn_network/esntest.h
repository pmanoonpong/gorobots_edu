...
const int num_hidden_ESN = 70; // Student Adjust!***
...
const double learning_rate_ESN = 0.99; // Student Adjust!***
...
//const int testing_start = 2000; /*training after, e.g., 2000 steps for learning modes "TestingData_4000.txt"*/
