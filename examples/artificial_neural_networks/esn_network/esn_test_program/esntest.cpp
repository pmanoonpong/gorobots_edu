...
TestESN::TestESN()
{
  ...
  //For students
  //***** Play with different transfer function of output neuron*******///
  ESN->outnonlinearity = 0; //0 = linear, 1 = sigmoid (logistic), 2  = tanh: transfer function of an output neuron
  //***** Play with different transfer function of output neuron*******///
  ...
  ESN->generate_random_weights(50/*if 10 means 10% sparsity = 90% connectivity */, 0.95 /*Spectral radius < 1.0 to maintain echo state property, 1.2-1.5 = chaotic*/);
