...
\includegraphics[width=5cm]{./pics/LogoUni.png} % [width=4cm,height=1.5cm]
 \includegraphics[width=2cm]{./pics/LogoBCCN.png}\\ % [width=3cm,height=3cm]
 \includegraphics[width=1.5cm]{./pics/SDUlogo.png} % [width=4cm,height=1.5cm]
\end{center}
...
\include{./sections/GoogleTest}
\include{./sections/camera_laserscanner}
\include{./sections/ROS_installation}
