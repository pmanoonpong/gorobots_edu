...
void Pcpg_controller::setParameter(float slope, float threshold)
{
...
void Pcpg_controller::run(float signal1, float signal2)
{
    ...
    if (this->pcpg_step[0] >=  this->threshold) {this->set[0] = 1.0;}
    if (this->pcpg_step[0] <   this->threshold) {this->set[0] = -1.0;}

    if (this->pcpg_step[1] >=  this->threshold) {this->set[1] = 1.0;}
    if (this->pcpg_step[1] <   this->threshold) {this->set[1] = -1.0;}
    ...
    if (this->set[0] == 1.0) {                                      // from 0 to 1 that mean slope positive
        this->countup[0] = this->countup[0] + 1.0;
        this->countdown[0] = 0.0;
    }
    if (this->set[0] == -1.0){                                      // from 1 to 0 that mean slope negative
    ...
    this->ydown[0] = ((-this->pcpg_slope/this->deltaxdown[0])*this->xdown[0]) + 1;
    ...
    this->ydown[1] = ((-1./this->deltaxdown[1])*this->xdown[1]) + 1;
