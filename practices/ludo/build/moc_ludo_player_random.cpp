...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ludo_player_random_t, stringdata) + ofs \
...
void ludo_player_random::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ludo_player_random::select_piece)) {
                *result = 0;
            }
        }
        {
            typedef void (ludo_player_random::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ludo_player_random::turn_complete)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject ludo_player_random::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ludo_player_random.data,
      qt_meta_data_ludo_player_random,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ludo_player_random.stringdata))
        return static_cast<void*>(const_cast< ludo_player_random*>(this));
