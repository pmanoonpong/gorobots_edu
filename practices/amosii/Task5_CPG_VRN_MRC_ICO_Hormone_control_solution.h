...
class EmptyController : public AbstractController {
  ...
  public:
    ...
    : AbstractController("EmptyController", "$Id: tripodgait18dof.cpp,v 0.1 $"){
     ...
     /// Neural Learning and Adaptation II: Hormone implementation, for students ///
     ...
     /////////////////////////////////////////////////////////////////////////////// 
      ...
      addInspectableValue("activityI1", &activityI1,"activityI1");
      addInspectableValue("activityI2", &activityI2,"activityI2");
      addInspectableValue("outputI1", &outputI1,"outputI1");
      addInspectableValue("outputI2", &outputI2,"outputI2");


      addInspectableValue("SI_future_1", &SI_future_1,"SI_future_1");
      addInspectableValue("SI_future_2", &SI_future_2,"SI_future_2");

      addInspectableValue("HC1", &HC_1,"Hormone concentration left");
      addInspectableValue("HR1", &HR_1,"Hormone receptor left");

      addInspectableValue("HC2", &HC_2,"Hormone concentration right");
      addInspectableValue("HR2", &HR_2,"Hormone receptor right");
...
*/
   ...
   *******************************************************************************/
    ...
    activityI1 = WeightI1_I1*outputI1+WeightI1_I2*outputI2+WeightI1_IR1*IR1_mapping+HR_1;
    activityI2 = WeightI2_I2*outputI2+WeightI2_I1*outputI1+WeightI2_IR2*IR2_mapping+HR_2;
    ...
    //outputI1_final = outputI1 * -HR_1; // Right IR --> go to left TC motors
    //outputI2_final = outputI2 * -HR_2; // Left IR  --> go to right TC motors
    
    //outputI1_final =  HR_2; // Right IR --> go to left TC motors
    //outputI2_final =  HR_1; // Left IR  --> go to right TC motors


 /*******************************************************************************
   *  MODULE 6 Artificial Hormone
   *******************************************************************************/
   /// Neural Learning and Adaptation II: Hormone implementation, for students ///
...
*/
    ...
    SI_future_1 = (IR1_mapping + SI_future_1)/2;
    SI_future_2 = (IR2_mapping + SI_future_2)/2;

    //SI_future_1 = (-1+SI_future_1)/2;
    //SI_future_2 = (-1+SI_future_2)/2;

    HC_1 = alpha_1 * (1/(1+exp(-SI_future_1))) + beta_1 * HC_1_old;
    if(HC_1 >=1.0){
      HC_1 =1.0;
    }else if(HC_1<=0.0){
      HC_1= 0.0;
    ...
    HC_2 = alpha_2 * (1/(1+exp(-SI_future_2))) + beta_2 * HC_2_old;
    if(HC_2 >=1.0){
      HC_2 =1.0;
    }else if(HC_2<=0.0){
      HC_2= 0.0;
