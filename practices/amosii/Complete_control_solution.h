...
class EmptyController : public AbstractController {
  ...
  public:
    ...
    : AbstractController("EmptyController", "$Id: tripodgait18dof.cpp,v 0.1 $"){
     ...
     /// Neural Control III: Neural preprocessing implementation, for students ///
      ...
      WeightI1_I1 = 2.35; //  2.35 optimal, Test 1: set all to 0.0, Test 2: I1_I1 = 2.0, Test 3: I1_I2, I2_I1 = -0.3
      WeightI2_I2 = 2.35;
      WeightI1_I2 = -0.3; // -0.3 optimal
      WeightI2_I1 = -0.3; 
     ...
     exploration_lowpass_old_g = 0.0;
      ...
      addInspectableValue("F", &F,"F");
      addInspectableValue("phi", &phi,"phi");
   ...
   *******************************************************************************/
     ...
     /// Neural Learning and Adaptation I: ICO implementation, for students ///
      ...
      ///// Condition for stable learning ///////////////
     /*if(input_distance_s < 0.009 || iii > 250)
      {
        deri_xt_reflex_angle = 0.0;
      }
      else
      {
        deri_xt_reflex_angle = deri_xt_reflex_angle;
      }*/
      ...
      w_ico += rate_ico*abs(deri_xt_reflex_angle)*abs(predictive_signal); //Red
      
      //exp_output*exp(-w_ico)
      //Exponential decay of exploration 
      exp_decay = exp_output*exp(-w_ico);
   
      //u_ico_out = u_ico+exp_output;
      u_ico_out = u_ico+exp_decay;
   ...
   *******************************************************************************/
    ...
    activityI1 = WeightI1_I1*outputI1+WeightI1_I2*outputI2+IR1_mapping;
    activityI2 = WeightI2_I2*outputI2+WeightI2_I1*outputI1+IR2_mapping;
