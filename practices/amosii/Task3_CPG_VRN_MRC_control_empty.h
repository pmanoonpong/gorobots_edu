...
class EmptyController : public AbstractController {
   ...
   *******************************************************************************/
    ...
    IR1_mapping = x_[FR_us];
    //IR2 on the left [0,...,1]
    IR2_mapping = x_[FL_us];

   
    activityI1 = 0;
    activityI2 = 0;
    outputI1 = 0; // Left  motors
    outputI2 = 0; // Right motors
  ...
  //**********VRN***************
    ...
    //Left motors    //Right sensor    
    Input1 = 0; // 1 = backward, -1 = forward, -1 = TR, 1 = TL

    //Right motors    //Left sensor
    Input2 = 0; // 1 = backward, -1 = forward, 1 = TR, -1 = TL  
   ...
   *******************************************************************************/
    ...
    y_[BJ_m] = 0;
      ...
      saveFile1 <<outputI1_final<<"  "<<IR1_mapping<<"  "<<x_[FR_us]<<" "<<outputI2_final<<" "<<IR2_mapping<<" "<<x_[FL_us]<<"   \n" << flush; //SAVE DATA
