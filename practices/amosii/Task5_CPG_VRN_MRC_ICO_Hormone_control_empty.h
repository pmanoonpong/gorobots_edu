...
class EmptyController : public AbstractController {
   ...
   *******************************************************************************/
   /// Neural Learning and Adaptation II: Hormone implementation, for students ///
    ...
    //setting Hormone Gland, for student
    SI_future_1 = IR1_mapping;
    SI_future_2 = IR2_mapping;

    HC_1 = 0;// add the equation
    HC_2 = 0;// add the equation
    
    //Limit the hormone concentration in range [0,1]
    if(HC_1 >=1.0){
      HC_1 =1.0;
    }else if(HC_1<=0.0){
      HC_1= 0.0;
    ...
    //update the hormone concentration (t-1)
    HC_1_old = HC_1;
    HC_2_old = HC_2;


    //setting Horomone receptor,for student
    HR_1 = 0;// add the equation
    HR_2 = 0;// add the equation
...
*/
   ...
   *******************************************************************************/
    ...
    //setting thereceptor to target cell
    outputI1_final = // add the equation // Right IR --> go to left TC motors
    outputI2_final = // add the equation // Left IR  --> go to right TC motors


  /*******************************************************************************
   *  MODULE Artificial Hormone 
   *******************************************************************************/
