...
#define CPG
//Note That: For decoupled CPGs implementation, the noise parameter in main.cpp should be set to a small value, otherwise the GRF cannot be identified from noise
...
class EmptyController : public AbstractController {
    ...
    public:
        ...
        virtual void stepNoLearning(const sensor* x_, int number_sensors,
            ...
            deri_xt_reflex_angle = 0; //----- Student
           ...
           // printf("reset %d iii %d\n",reset, iii);
            ...
            for(unsigned int idx=0;idx<leg_num;idx++){
                ...
                //** STudents Modify here: program the CPGs_activityH1.at(idx) = ... and CPGs_activityH2= ... **//
            ...
            */
            ...
            //** Student modify Here, please finish the program as follows **//
            //M0  
