...
private:
	...
	enum RealAmosIISensorNames{
	 ...
	 /*Add more sensors here according to the port of the MBoard*/
		...
		//Change here
		R0_fs_real= 5, //Right Foot Sensor F 13.
		R1_fs_real= 7, //Right Foot Sensor M 11.
		R2_fs_real= 9,  //Right Foot Sensor B 9.
		L0_fs_real= 4, //Left Foot Sensor F 14.
		L1_fs_real= 6, //Left Foot Sensor M 12.
		L2_fs_real= 8, //Left Foot Sensor B 10.

		//US sensor at front
		FR_us_real= 1, //Front Right US Sensor 1
		FL_us_real= 2, //Front Left US Sensor 2

		//Reflex ir sensors at leg
		R0_irs_real=27, //F Right IR reflex sensor 27 only pup values at diagram
		R1_irs_real=28, //M Right IR reflex sensor 28
		R2_irs_real=30, //B Right IR reflex sensor 30

		L0_irs_real=25, //F Left IR reflex sensor 25
		L1_irs_real=26, //M Left IR reflex sensor 26
		L2_irs_real=18, //B Left IR reflex sensor 18

		//light sensors
		M_ps_real=23, //Mid Light Sensor 23 Medium sensor missing on diagram.
		R_ps_real=3, //Right Light Sensor 15.
		L_ps_real=9, //Left Light Sensor 32.

		//Average current sensor of all motors [ZAP25]
		A_cs_real= 19, //Current Sensor 29.

		//Inclinometer sensor
		In_x_real=8, //Inclinometer X 8
		In_y_real=7, //Inclinometer Y 7
