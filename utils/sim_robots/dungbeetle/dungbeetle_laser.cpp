...
if(conf.useLidar){
    ...
    nameSensor(F_lid_3, "*lidar 3");
    nameSensor(F_lid_4, "*lidar 4");
    nameSensor(F_lid_5, "*lidar 5");
    nameSensor(F_lid_6, "*lidar 6");
    nameSensor(F_lid_7, "*lidar 7");
    nameSensor(F_lid_8, "*lidar 8");
    nameSensor(F_lid_9, "*lidar 9");
    nameSensor(F_lid_10, "*lidar 10");
    nameSensor(F_lid_11, "*lidar 11");
    nameSensor(F_lid_12, "*lidar 12");
    nameSensor(F_lid_13, "*lidar 13");
    nameSensor(F_lid_14, "*lidar 14");
    nameSensor(F_lid_15, "*lidar 15");
    nameSensor(F_lid_16, "*lidar 16");
    nameSensor(F_lid_17, "*lidar 17");
    nameSensor(F_lid_18, "*lidar 18");
    nameSensor(F_lid_19, "*lidar 19");
    nameSensor(F_lid_20, "*lidar 20");
    nameSensor(F_lid_21, "*lidar 21");
    nameSensor(F_lid_22, "*lidar 22");
    nameSensor(F_lid_23, "*lidar 23");
    nameSensor(F_lid_24, "*lidar 24");
    nameSensor(F_lid_25, "*lidar 25");
    nameSensor(F_lid_26, "*lidar 26");
    nameSensor(F_lid_27, "*lidar 27");
    nameSensor(F_lid_28, "*lidar 28");
    nameSensor(F_lid_29, "*lidar 29");
    nameSensor(F_lid_30, "*lidar 30");
    nameSensor(F_lid_31, "*lidar 31");
    nameSensor(F_lid_32, "*lidar 32");
    nameSensor(F_lid_33, "*lidar 33");
    nameSensor(F_lid_34, "*lidar 34");
    nameSensor(F_lid_35, "*lidar 35");
    nameSensor(F_lid_36, "*lidar 36");
...
*/
  ...
  // ------------- Front legs -------------
    ...
    c.mcoxaJointLimitB = M_PI / 180 * 110.0;
    ...
    c.rcoxaJointLimitB = M_PI / 180.0 * 110.0;
    //added separated CTr joint limit by Michelangelo
